...
export default function (server) {
  server.register(Auth, {
    ...
    signInPath: "/",
    /**
     * Configures whether or not your app will respond with a 403 (`false`), or redirect to the `signInPath` (`true`) when an unauthenticated request is made to one of your server-side protected routes.
     */
